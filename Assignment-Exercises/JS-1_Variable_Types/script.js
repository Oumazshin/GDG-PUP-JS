...
// Using let
let name = "James Clark"; // Define a string here, e.g., "Juan Cruz"
let age = 20; // Define a number here, e.g., 30
let isStudent = true; // Define a boolean here, e.g., true or false
let hobbies = ["Reading Manga", "Gaming", "Watching Sitcoms"]; // Define an array here, e.g., ["reading", "gaming", "coding"]
...
const favoriteBooks = ["2018", "Chainsaw Man", "Tatsuki Fujimoto"]; // Define an array here, e.g., ["1984", "Brave New World", "Fahrenheit 451"]
...
// Using var
var city = "Taguig City"; // Define a string here, e.g., "New York"
var temperature = "32.5"; // Define a number here, e.g., 22.5
var hasPets = true; // Define a boolean here, e.g., true or false
var colors = ["Black", "White", "Grey"]; // Define an array here, e.g., ["red", "green", "blue"]
